        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Scaling Ad Spend & ROI</h4>
              <p>
                Expert in managing high-budget campaigns across Google Ads, Meta Ads, and LinkedIn Ads. Specializing in full-funnel strategies, CRO, and lead generation.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>SEO, AEO & GEO Strategies</h4>
              <p>
                Growing organic traffic through technical SEO, content strategy, and link building. Proven track record of scaling traffic from 100 to 86K monthly visitors.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">On-Page SEO</div>
                <div className="what-tags">Tech SEO</div>
                <div className="what-tags">AEO & GEO</div>
                <div className="what-tags">SEMrush</div>
                <div className="what-tags">Ahrefs</div>
                <div className="what-tags">GA4</div>
                <div className="what-tags">GSC</div>
